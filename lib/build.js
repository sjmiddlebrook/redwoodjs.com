    ...
    files: [
      {
        ...
        title: 'Introduction',
        skipLines: 4,
        githubPath: 'https://github.com/redwoodjs/redwood/blob/main/README.md',
      },
      {
        pageBreakAtHeadingDepth: [1],
      ...
      },
      {
        ...
        githubPath: 'https://github.com/redwoodjs/redwood/blob/main/packages/auth/README.md'
      },
      {
        pageBreakAtHeadingDepth: [1],
        url: './docs/builds.md',
      ...
      },
      {
        ...
        githubPath: 'https://github.com/redwoodjs/redwood/blob/main/packages/router/README.md'
      },
      {
        pageBreakAtHeadingDepth: [1],
